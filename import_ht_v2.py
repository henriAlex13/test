...
def importer_factures_ht(df_ht, df_base_centrale, periode, has_typefact):
    ...
    for _, row_facture in df_traite.iterrows():
        ...
        # ✨ CORRECTION : is_e1 doit vérifier le TYPE de la facture ACTUELLE, pas si une E1 existe pour ce site
        # Comme les E1 ne sont PAS dans df_traite, is_e1 devrait TOUJOURS être False ici
